...
|  --- | --- | --- | --- |
| `categoryList` | [`CategoryList`](../../doc/models/category-list.md) | Required | - |

## Example

```ts
import { CategoriesJsonResponse1 } from 'discourse-api-documentationlib';

const categoriesJsonResponse1: CategoriesJsonResponse1 = {
  categoryList: {
