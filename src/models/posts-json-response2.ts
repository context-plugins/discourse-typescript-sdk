...
import { actionsSummary2Schema, type ActionsSummary2 } from "./actions-summary2.js";

export type PostsJsonResponse2 = {
  id: number;
  username: string;
  ...
  bookmarked: boolean;
  raw: string;
  actionsSummary: ActionsSummary2[];
  moderator: boolean;
  admin: boolean;
  staff: boolean;
  userId: number;
...
export const postsJsonResponse2Schema: Schema<PostsJsonResponse2> = s.object<PostsJsonResponse2>({
  id: s.number(),
  username: s.string(),
  ...
  raw: s.string(),
  actionsSummary: s.array(s.lazy(() => actionsSummary2Schema)),
  moderator: s.boolean(),
  admin: s.boolean(),
  staff: s.boolean(),
  userId: s.number(),
